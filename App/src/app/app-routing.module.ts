...
const routes: Routes = [
  ...
  { path: 'workspace/null', redirectTo: 'workspace/' + localStorage.getItem('Email'), canActivate: [AuthGuardService] },
  { path: 'workspace/:email', component: WorkPageComponent, canActivate: [AuthGuardService], loadChildren: () => import('src/app/workspace/workspace.module').then(m => m.WorkspaceModule) },
